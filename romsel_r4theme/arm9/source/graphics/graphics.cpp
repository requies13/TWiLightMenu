...
int brightnessTexID, manualTexID, iconboxTexID, wirelessiconTexID;

glImage brightnessIcon[1];
...
{	
	...
	u16* newPalette = (u16*)icon_brightnessPal;
	if (colorTable) {
	...
	brightnessTexID = glLoadTileSet(brightnessIcon, // pointer to glImage array
							16, // sprite width
							16, // sprite height
							16, // bitmap width
							16, // bitmap height
							...
							(u8*) icon_brightnessBitmap // image data generated by GRIT
							);

	newPalette = (u16*)icon_manualPal;
	if (colorTable) {
